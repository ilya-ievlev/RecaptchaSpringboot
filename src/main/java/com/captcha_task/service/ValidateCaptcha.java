package com.captcha_task.service;

import com.captcha_task.dto.CaptchaDto;
...
public class ValidateCaptcha {
    ...
    public boolean validateCaptcha(final String captchaResponse) {
        ...
        CaptchaDto apiResponse = null;
        try {
            apiResponse = template.postForObject(recaptchaEndpoint, params, CaptchaDto.class);
